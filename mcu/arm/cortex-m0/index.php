        ...
        <div class="container-fluid">
          ...
          <div id="menu-topics" class="menu-topics">
            ...
            <li><a href="../arm7">ARM7-TDMI</a></li>
              <li  class="active"><a href="../cortex-m0">CORTEX-M0</a></li>
  ...
  <div class="main-container">
      <main class="main">
        <section class="top-section">
          <div class="content">
            ...
            <div class="content-col">
              <h2 class="center-me">COTREX-M0 Series</h2>
        ...
        <section class="top-section-subsec">
          <div class="card-sec">
               <a href="lpc1112fhn33-101/"> 
                  <div class="atmellogo">
                    <h2>LPC1112FHN33/101</h2>
                    <div class="container">
                ...
                <a href="lpc1114fhn33-303/"> 
                  <div class="mchiplogo">
                   <h2>LPC1114FHN33/303</h2>
                    <div class="container">
                      <h5> Learn <i class="fa fa-arrow-right "></i></h5>
                    </div> 
                  </div> 
               ...
               <a href="lpc1115fbd48-303/"> 
                  <div class="mchiplogo">
                   <h2>LPC1115FBD48/303</h2>
                    <div class="container">
                      <h5> Learn <i class="fa fa-arrow-right "></i></h5>
                    </div> 
                  </div> 
