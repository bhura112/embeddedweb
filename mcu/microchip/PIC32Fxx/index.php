        ...
        <div class="container-fluid">
          ...
          <div id="menu-topics" class="menu-topics">
            <ul id="navbar-nav" class="nav navbar-nav">
              ...
              <li class="active"><a href=".">PIC32</a></li>
            </ul>
          </div>
  ...
  <div class="main-container">
      <main class="main">
        <section class="top-section">
          <div class="content">
            ...
            <div class="content-col">
              <h2 class="center-me">PIC32F Series</h2>
        ...
        <section class="top-section-subsec">
          <div class="card-sec">
               <a href="pic32mx695f512/"> 
                  <div class="atmellogo">
                    <h2>PIC32MX695F512</h2>
                    <div class="container">
                ...
                <a href="pic32mx795f512/"> 
                  <div class="atmellogo">
                    <h2>PIC32MX795F512</h2>
                    <div class="container">
                      <h5> Learn <i class="fa fa-arrow-right "></i></h5>
                    </div> 
                  </div> 
